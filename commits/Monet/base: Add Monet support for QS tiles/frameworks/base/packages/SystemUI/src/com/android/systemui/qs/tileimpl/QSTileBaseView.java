...
public class QSTileBaseView extends com.android.systemui.plugins.qs.QSTileView {
    ...
    private final int mColorBackgroundInactive;
    ...
    public QSTileBaseView(Context context, QSIconView icon, boolean collapsedView) {
        ...
        int mBackgroundInactive = context.getResources().getColor(R.color.monet_qs_tile_inactive_background);

        mColorBackgroundInactive = nightMode && mBackgroundInactive != Color.BLACK
                ? ColorUtils.setAlphaComponent(mBackgroundInactive, 38)
                : ColorUtils.setAlphaComponent(activeColor, 51);
    ...
    private int getCircleColor(int state) {
        switch (state) {
            case Tile.STATE_ACTIVE:
                return mColorActive;
            case Tile.STATE_INACTIVE:
                return mColorBackgroundInactive;
            case Tile.STATE_UNAVAILABLE:
                return Utils.getDisabled(mContext, mColorBackgroundInactive);
            default:
