...
public abstract class QSTileImpl<TState extends State> implements QSTile, LifecycleOwner, Dumpable {
    ...
    private static final String TAG_CUSTOM = "QSTileImpl";
    protected static final boolean DEBUG_CUSTOM = SystemProperties.getBoolean(
            "persist.sys.debug", false);
    ...
    public static int getColorForState(Context context, int state) {
        ...
        int mIconActive = context.getResources().getColor(R.color.monet_qs_tile_active_icon);
        int mIconInactive = context.getResources().getColor(R.color.monet_qs_tile_inactive_icon);
        dlog(String.format("mIconActive = %d, mIconInactive = %d", mIconActive, mIconInactive));

        final int mColorIconActive = isMonetColor(mIconActive, nightMode) ? mIconActive
                : Utils.getColorAttrDefaultColor(context, android.R.attr.textColorPrimaryInverse);
        final int mColorIconInactive = isMonetColor(mIconInactive, nightMode) ? mIconInactive
                : Utils.getColorAttrDefaultColor(context, android.R.attr.textColorSecondary);
        dlog(String.format("mColorIconActive = %d, mColorIconInactive = %d",
                mColorIconActive, mColorIconInactive));

        switch (state) {
            case Tile.STATE_UNAVAILABLE:
                return Utils.getDisabled(context, mColorIconInactive);
            case Tile.STATE_INACTIVE:
                return mColorIconInactive;
            case Tile.STATE_ACTIVE:
                return mColorIconActive;
            default:
    ...
    private static boolean isMonetColor(int color, boolean nightMode) {
        return nightMode && color != Color.BLACK;
    }
