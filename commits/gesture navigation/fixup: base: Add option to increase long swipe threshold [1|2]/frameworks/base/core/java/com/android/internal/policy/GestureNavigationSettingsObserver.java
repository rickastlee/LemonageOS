...
public class GestureNavigationSettingsObserver extends ContentObserver {
    ...
    public void register() {
        ...
        r.registerContentObserver(
                ...
                false, this, UserHandle.USER_ALL);
        boolean observeLongSwipe = SystemProperties.getBoolean(
                "persist.sys.gestures.observe_long_swipe", true);
        if (observeLongSwipe) {
            r.registerContentObserver(
                    Settings.System.getUriFor(Settings.System.EDGE_LONG_SWIPE_THRESHOLD),
                    false, this, UserHandle.USER_ALL);
        }
    ...
    public int getDeadZoneMode() {
        int mode = Settings.System.getIntForUser(mContext.getContentResolver(),
            Settings.System.EDGE_GESTURE_Y_DEAD_ZONE, 0, UserHandle.USER_CURRENT);
        return mode;
    }
}