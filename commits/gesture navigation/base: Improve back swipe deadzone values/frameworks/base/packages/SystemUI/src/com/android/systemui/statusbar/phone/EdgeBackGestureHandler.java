...
public class EdgeBackGestureHandler extends CurrentUserTracker implements DisplayListener,
    ...
    // The back swipe deadzone height scale
    private float mYDeadzoneHeightScale;
    ...
    public void updateCurrentUserResources() {
        ...
        mYDeadzoneHeightScale = mGestureNavigationSettingsObserver.getDeadZoneMode() * 0.2f;
    ...
    private boolean isWithinTouchRegion(int x, int y) {
        ...
        if (y < (int) (mDisplaySize.y * mYDeadzoneHeightScale)) {
            return false;
        }
