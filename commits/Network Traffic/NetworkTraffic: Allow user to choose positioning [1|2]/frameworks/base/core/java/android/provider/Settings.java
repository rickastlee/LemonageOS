...
public final class Settings {
    ...
    /**
     * Activity Action: Show quick torch settings
     *
     * @hide
     */
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    public static final String ACTION_QUICK_TORCH_SETTINGS =
            "android.settings.ACTION_QUICK_TORCH_SETTINGS";
    ...
    public static final class System extends NameValueTable {
        ...
        /**
         * Indicates whether the System UI has been restarted
         * 0 - in progress
         * 1 - executed
         * @hide
         */
        public static final String SYSUI_RESTART_COMPLETE = "sysui_restart_complete";
        ...
        /**
         * Setting to determine the edge long swipe threshold
         * 0 = default value
         * 1 = half the screen width
         * @hide
         */
        public static final String EDGE_LONG_SWIPE_THRESHOLD = "edge_long_swipe_threshold";
	...
	/**
         * The percentage by which the artwork in QS media player is darkened
         * @hide
         */
        public static final String DARKEN_MEDIA_ARTWORK = "darken_media_artwork";

        /**
         * Settings user avatar style
         * 0 = hidden
         * 1 = custom image
         * @hide
         */
        public static final String USER_AVATAR_STYLE = "user_avatar_style";
        ...
        /**
         * Wheter to use a custom accent color in supported lock screen clocks
         * @hide
         */
        public static final String LOCK_SCREEN_CLOCK_USE_CUSTOM_ACCENT_COLOR = "lock_screen_clock_use_custom_accent_color";

        /**
         * The custom accent color to be used in supported lock screen clocks
         * @hide
         */
        public static final String LOCK_SCREEN_CLOCK_CUSTOM_ACCENT_COLOR = "lock_screen_clock_custom_accent_color";
    ...
    public static final class Secure extends NameValueTable {
        ...
        /**
         * Whether the Airplane Mode button should be shown in the power menu.
         * @hide
         */
        ...
        /**
         * Position of gesture bar radius slider.
         * @hide
         */
        ...
        /**
         * Toggles swipe up hint in gestural nav mode (boolean value)
         * @hide
         */
        public static final String NAVIGATION_BAR_HINT = "navigation_bar_hint";

        /**
         * Setting to hold the current set overlay for dashboard icons.
         * @hide
         */
        public static final String SETTINGS_DASHBOARD_ICONS = "settings_dashboard_icons";

        /**
         * Whether to use the avatar set by the user on Settings homepage.
         * @hide
         */
        public static final String USER_AVATAR_CUSTOM = "user_avatar_custom";
