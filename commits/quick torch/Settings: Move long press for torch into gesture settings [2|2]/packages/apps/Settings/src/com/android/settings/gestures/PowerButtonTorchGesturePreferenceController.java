...
public class PowerButtonTorchGesturePreferenceController extends GesturePreferenceController {
    ...
    public int getAvailabilityStatus() {
        return org.lineageos.settings.utils.Utils.deviceSupportsFlashLight(mContext)
    ...
    public boolean setChecked(boolean isChecked) {
        return LineageSettings.System.putInt(mContext.getContentResolver(),
                LineageSettings.System.TORCH_LONG_PRESS_POWER_GESTURE, isChecked ? ON : OFF);
    }

    @Override
    public boolean isChecked() {
        return LineageSettings.System.getInt(mContext.getContentResolver(), 
                LineageSettings.System.TORCH_LONG_PRESS_POWER_GESTURE, 0) != 0;
    }
}