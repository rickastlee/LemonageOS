...
public class PowerMenuActions extends SettingsPreferenceFragment {
    ...
    public void onStart() {
        ...
        if (mScreenshotPref != null) {
            boolean screenshotEnabled = Settings.Secure.getIntForUser(getContentResolver(),
                    Settings.Secure.SCREENSHOT_IN_POWER_MENU, 0, UserHandle.USER_CURRENT) == 1;
            mScreenshotPref.setChecked(screenshotEnabled);
        }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (preference == mScreenshotPref) {
            ...
            Settings.Secure.putIntForUser(getContentResolver(),
                    Settings.Secure.SCREENSHOT_IN_POWER_MENU, value ? 1 : 0, UserHandle.USER_CURRENT);
