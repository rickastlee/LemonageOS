...
public class PowerMenuActions extends SettingsPreferenceFragment {
    ...
    public void onStart() {
        ...
        if (mUsersPref != null) {
            if (!UserHandle.MU_ENABLED || !UserManager.supportsMultipleUsers()) {
                ...
                boolean userSwitcherEnabled = Settings.Secure.getIntForUser(getContentResolver(),
                        Settings.Secure.USER_SWITCHER_IN_POWER_MENU, 0, UserHandle.USER_CURRENT) == 1;
                mUsersPref.setChecked(userSwitcherEnabled && enabled);
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (preference == mAirplanePref) {
            ...
            Settings.Secure.putIntForUser(getContentResolver(),
                    Settings.Secure.USER_SWITCHER_IN_POWER_MENU, value ? 1 : 0, UserHandle.USER_CURRENT);
