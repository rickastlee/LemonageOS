...
public class AndroidTwelveClockController implements ClockPlugin {
    ...
    public Bitmap getPreview(int width, int height) {
        boolean previewSetViews = SystemProperties.getBoolean(
                    "persist.sys.twelve.preview_set_views", true);
        boolean previewOnTimeTick = SystemProperties.getBoolean(
                    "persist.sys.twelve.preview_on_time_tick", true);

        View previewView = mLayoutInflater.inflate(getPreviewResId(), null);
        if (previewSetViews) setViews(previewView);

        TextClock previewClock = previewView.findViewById(R.id.clock);
        previewClock.setFormat12Hour("h:mm");
        previewClock.setFormat24Hour("kk:mm");

        if (previewOnTimeTick) onTimeTick();
    ...
    private int getPreviewResId() {
        int previewLayout = SystemProperties.getInt(
                "persist.sys.twelve.preview_layout", 0);
        switch (previewLayout) {
            case 1:
                return R.layout.android_twelve_clock_preview_1;
            case 2:
                return R.layout.android_twelve_clock_preview_2;
            case 3:
                return R.layout.android_twelve_clock_preview_3;
            case 4:
                return R.layout.android_twelve_clock_preview_4;
            case 5:
                return R.layout.android_twelve_clock_preview_5;
            case 6:
                return R.layout.android_twelve_clock_preview_6;
            case 7:
                return R.layout.android_twelve_clock_preview_7;
            case 8:
                return R.layout.android_twelve_clock_preview_8;
            case 9:
                return R.layout.android_twelve_clock_preview_9;
            case 10:
                return R.layout.android_twelve_clock_preview_10;
        }
        return R.layout.android_twelve_clock_preview;
    }
    ...
    private void updateTextColors() {
        ...
        if (mUseCustomAccent) {
            ...
            mClock.setTextColor(mCustomAccent);
        } else {
