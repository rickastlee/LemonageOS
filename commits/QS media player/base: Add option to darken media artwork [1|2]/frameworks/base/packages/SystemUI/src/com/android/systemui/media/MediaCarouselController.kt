...
class MediaCarouselController @Inject constructor(
    ...
    private var artworkSettingObserverInitialized = false
    ...
    init {
        ...
        initArtworkSettingObserver(context)
    }
    ...
    private fun initArtworkSettingObserver(context: Context) {
        if (artworkSettingObserverInitialized) {
            return
        }

        val artworkSettingObserver =
        ...
        context.contentResolver.registerContentObserver(
                Settings.System.getUriFor(Settings.System.ARTWORK_MEDIA_BACKGROUND),
                false /* notifyForDescendants */, artworkSettingObserver)
        context.contentResolver.registerContentObserver(
                Settings.System.getUriFor(Settings.System.DARKEN_MEDIA_ARTWORK),
                false /* notifyForDescendants */, artworkSettingObserver)

        artworkSettingObserverInitialized = true
    }
}
