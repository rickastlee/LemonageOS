...
public class BatteryMeterView extends LinearLayout implements
    ...
    private void setPercentTextAtCurrentLevel() {
            ...
            boolean useEscapeSequence = SystemProperties.getBoolean("persist.sys.bolt.use_escape_sequence", true);
            String bolt = useEscapeSequence ? "\u26A1\uFE0E" : "⚡︎";
            ...
            setContentDescription(
                    getContext().getString(mCharging
