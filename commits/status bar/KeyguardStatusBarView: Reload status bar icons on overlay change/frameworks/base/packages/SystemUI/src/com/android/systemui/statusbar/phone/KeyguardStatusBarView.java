...
public class KeyguardStatusBarView extends RelativeLayout
    ...
    protected void onAttachedToWindow() {
        ...
        mIconController.addIconGroup(mIconManager);
        onThemeChanged();
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        mIconController.removeIconGroup(mIconManager);
    ...
    public void onOverlayChanged() {
        ...
        String blackListStr = Settings.Secure.getStringForUser(mContext.getContentResolver(),
                StatusBarIconController.ICON_BLACKLIST, ActivityManager.getCurrentUser());
        dlog("onOverlayChanged: blackListStr = " + blackListStr);
        ((StatusBarIconControllerImpl) mIconController).reloadStatusBarIcons(blackListStr);
        dlog("onOverlayChanged: reloadStatusBarIcons");
    }
