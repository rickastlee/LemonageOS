...
public class Theming extends DashboardFragment implements Indexable, OnPreferenceChangeListener{
    ...
    private SystemSettingListPreference mAvatarStyle;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAvatarStyle = (SystemSettingListPreference) findPreference(AVATAR_STYLE);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        switch (key) {
            ...
            case UI_ROUNDNESS_PICKER:
                ...
                break;
            case AVATAR_STYLE:
                com.android.internal.util.lineageos.Utils.killProcess(mContext, "com.android.settings");
                break;
        }
        return true;
    }
