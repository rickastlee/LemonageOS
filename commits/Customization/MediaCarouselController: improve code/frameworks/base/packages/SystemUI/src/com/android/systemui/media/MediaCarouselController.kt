...
class MediaCarouselController @Inject constructor(
    ...
    private var backgroundArtwork: Boolean = true
    private var darkenArtwork: Int = 30
    ...
    private fun addOrUpdatePlayer(key: String, oldKey: String?, data: MediaData) {
        ...
        if (existingPlayer == null) {
            ...
            newPlayer.updateBgArtworkParams(backgroundArtwork, darkenArtwork)
            ...
            existingPlayer.updateBgArtworkParams(backgroundArtwork, darkenArtwork)
    ...
    inner class SettingsObserver: ContentObserver {
        ...
        fun observe() {
            ...
            contentResolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.DARKEN_MEDIA_ARTWORK),
                    false, this, UserHandle.USER_CURRENT)
        }
        ...
        private fun update() {
            ...
            darkenArtwork = Settings.System.getInt(contentResolver,
                Settings.System.DARKEN_MEDIA_ARTWORK, 30);
        }
    }
}
