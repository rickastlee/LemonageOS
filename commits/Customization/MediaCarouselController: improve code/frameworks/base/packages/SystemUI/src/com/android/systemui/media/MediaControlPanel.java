...
public class MediaControlPanel {
    ...
    private boolean mBackgroundArtwork = true;
    private int mDarkenArtwork = 30;
    ...
    public void updateBgArtworkParams(boolean backgroundArtwork, int darkenArtwork) {
        mBackgroundArtwork = backgroundArtwork;
        mDarkenArtwork = darkenArtwork;
    }
    ...
    public void bind(@NonNull MediaData data, String key) {
        ...
        if (hasArtwork) {
                if (mBackgroundArtwork) {
                    ...
                    setArtworkLightness(backgroundImage); 
    ...
    private void setArtworkLightness(ImageView backgroundImage) {
        int lightness = (int) (255 * (1 - mDarkenArtwork / 100f));
        backgroundImage.setColorFilter(Color.rgb(lightness, lightness, lightness),
