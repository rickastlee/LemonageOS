...
public class Theming extends DashboardFragment implements Indexable, OnPreferenceChangeListener{
    ...
    private void updateIsCustomAccentEnabled() {
        if (mClockCustomAccent != null && mClockAccentPicker != null) {
            dlog("updateIsCustomAccentEnabled: mClockCustomAccent != null && mClockAccentPicker != null");
            ...
            mClockAccentPicker.setEnabled(supported);
        }
    }
