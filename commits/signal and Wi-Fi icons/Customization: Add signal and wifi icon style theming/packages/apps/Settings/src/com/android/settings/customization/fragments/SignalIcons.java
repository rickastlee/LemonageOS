...
public class SignalIcons extends SettingsPreferenceFragment {
    ...
    public class Adapter extends RecyclerView.Adapter<Adapter.CustomViewHolder> {
        ...
        public void onBindViewHolder(CustomViewHolder holder, final int position) {
            ...
            holder.image1.setBackgroundDrawable(getDrawable(holder.image1.getContext(), iconPkg, "ic_sb_signal_cellular_1_5_bar"));
            holder.image2.setBackgroundDrawable(getDrawable(holder.image2.getContext(), iconPkg, "ic_sb_signal_cellular_2_5_bar"));
            holder.image3.setBackgroundDrawable(getDrawable(holder.image3.getContext(), iconPkg, "ic_sb_signal_cellular_3_5_bar"));
            holder.image4.setBackgroundDrawable(getDrawable(holder.image4.getContext(), iconPkg, "ic_sb_signal_cellular_5_5_bar"));
