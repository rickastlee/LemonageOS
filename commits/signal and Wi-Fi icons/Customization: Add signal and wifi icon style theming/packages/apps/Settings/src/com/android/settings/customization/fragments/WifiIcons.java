...
public class WifiIcons extends SettingsPreferenceFragment {
    ...
    public class Adapter extends RecyclerView.Adapter<Adapter.CustomViewHolder> {
        ...
        public void onBindViewHolder(CustomViewHolder holder, final int position) {
            ...
            holder.image1.setBackgroundDrawable(getDrawable(holder.image1.getContext(), iconPkg, "ic_sb_wifi_signal_1"));
            holder.image2.setBackgroundDrawable(getDrawable(holder.image2.getContext(), iconPkg, "ic_sb_wifi_signal_2"));
            holder.image3.setBackgroundDrawable(getDrawable(holder.image3.getContext(), iconPkg, "ic_sb_wifi_signal_3"));
            holder.image4.setBackgroundDrawable(getDrawable(holder.image4.getContext(), iconPkg, "ic_sb_wifi_signal_4"));
