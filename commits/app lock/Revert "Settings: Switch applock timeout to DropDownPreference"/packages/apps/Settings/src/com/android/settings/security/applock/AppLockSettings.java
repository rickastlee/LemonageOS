                ...
                public CharSequence provideSummary(ListPreference preference) {
                    ...
                    switch (selectedLockTimeout) {
                        ...
                        case 15:
                            ...
                            break;
                        case 30:
                            summaryText = String.valueOf(getText(R.string.applock_lock_after_30_seconds_summary));
                            break;
                        case 60:
                            summaryText = String.valueOf(getText(R.string.applock_lock_after_1_minute_summary));
                            break;
                        case 120:
                            summaryText = String.valueOf(getText(R.string.applock_lock_after_2_minutes_summary));
                            break;
                        case 240:
                            summaryText = String.valueOf(getText(R.string.applock_lock_after_4_minutes_summary));
                            break;
                        case -1:
