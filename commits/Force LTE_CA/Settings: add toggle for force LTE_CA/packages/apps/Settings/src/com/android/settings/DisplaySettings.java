...
import com.android.settings.display.BrightnessCurveImplPreferenceController;
import com.android.settings.display.BrightnessLevelPreferenceController;
import com.android.settings.display.CameraGesturePreferenceController;
import com.android.settings.display.EnableBlursPreferenceController;
import com.android.settings.display.ForceLteCaPreferenceController;
import com.android.settings.display.GameSpoofPreferenceController;
...
public class DisplaySettings extends DashboardFragment {
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(
        ...
        controllers.add(new BrightnessCurveImplPreferenceController(context));
        controllers.add(new ForceLteCaPreferenceController(context));
        return controllers;
    }
