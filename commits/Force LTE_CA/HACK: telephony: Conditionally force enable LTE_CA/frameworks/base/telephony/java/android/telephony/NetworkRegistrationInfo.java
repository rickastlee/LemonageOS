...
public final class NetworkRegistrationInfo implements Parcelable {
    ...
    public void setAccessNetworkTechnology(@NetworkType int tech) {
        ...
        boolean forceCarrierAggregation = Boolean.parseBoolean(
                SystemProperties.get("persist.sys.radio.force_lte_ca", "true"));
        if (forceCarrierAggregation && tech == TelephonyManager.NETWORK_TYPE_LTE) {
