...
public class EditUserInfoController {
    ...
    private static final String TAG = "EditUserInfoController";
    ...
    public Dialog createDialog(final Fragment fragment, final Drawable currentUserIcon,
        ...
        dlog("createDialog: canChangePhoto = " + canChangePhoto);
        if (!canChangePhoto) {
    ...
    boolean canChangePhoto(Context context, UserInfo user) {
        boolean canCropPhoto = PhotoCapabilityUtils.canCropPhoto(context);
        ...
        dlog(String.format(
                "canChangePhoto: canCropPhoto = %b, canChoosePhoto = %b, canTakePhoto = %b",
                canCropPhoto, canChoosePhoto, canTakePhoto));
