...
public class PixelPropsUtils {
    ...
    private static final String SPOOF_GMS = "persist.sys.pixelprops.spoof_gms";
    ...
    public static void spoofBuildGms(Context context) {
        boolean shouldSpoofGms = SystemProperties.getBoolean(SPOOF_GMS, true);
        if (!shouldSpoofGms) {
            dlog("spoofBuildGms: return, reason: shouldSpoofGms = false");
            return;
        }

        String packageName = "org.lineageos.enforcedhardwareattestation";
