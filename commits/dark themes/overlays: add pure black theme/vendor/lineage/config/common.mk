...
# Monet dark themes
PRODUCT_PACKAGES += \
    SystemMonetAmberOverlay \
    SystemMonetBlueOverlay \
    SystemMonetGreenOverlay \
    SystemMonetLimeOverlay \
    SystemMonetOrangeOverlay \
    SystemMonetPinkOverlay \
    SystemMonetPurpleOverlay \
    SystemMonetRedOverlay \
    SystemMonetTealOverlay \
    SystemUIMonetAmberOverlay \
    SystemUIMonetBlueOverlay \
    SystemUIMonetGreenOverlay \
    SystemUIMonetLimeOverlay \
    SystemUIMonetOrangeOverlay \
    SystemUIMonetPinkOverlay \
    SystemUIMonetPurpleOverlay \
    SystemUIMonetRedOverlay \
    SystemUIMonetTealOverlay
...
PRODUCT_PACKAGES += \
    GesturalNavigationRadiusLarge \
    GesturalNavigationRadiusMedium \
    GesturalNavigationRadiusSmall
